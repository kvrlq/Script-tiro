...
function Notify(msg)
    ...
    n.Position = UDim2.new(0.5, -120, 0.05, 0)
...
LoginFrame.Size = UDim2.new(0, 300, 0, 310)
LoginFrame.Position = UDim2.new(0.5, -150, 0.5, -155)
...
PremiumBtn.ZIndex = 201
PremiumBtn.Parent = LoginFrame
...
LoginStatus.Position = UDim2.new(0, 0, 0, 250)
...
local function Tgl(text, default, feature, callback)
    ...
    lbl.Size = UDim2.new(0.65, 0, 1, 0); lbl.Position = UDim2.new(0.05, 0, 0, 0)
